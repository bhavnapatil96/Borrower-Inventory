                                    ...
                                    <div className="col-md-9 personal-info">
                                        <form onSubmit={this.sendData} className="form-horizontal" role="form">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div className="col-lg-8">
                                                    <input className="form-control" required={true} type="text" value={this.state.address} onChange={(e)=>{this.setState({address:e.target.value})}}/>
                                                </div>
                                            </div>
                                            <div className="form-group">
...
export default connect(mapStateToProps,matchDispatchToProps)(CustomerEditProfile);
